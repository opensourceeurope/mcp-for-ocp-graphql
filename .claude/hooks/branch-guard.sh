...
# Generated artifacts must never be hand-edited — edit the sources and regenerate.
case "$file" in
  */cherry-studio/opencollective-analyst/SKILL.md)
    deny "This file is GENERATED by scripts/build_cherry_skill.py (merged from the plugin's agent + querying skill). Don't hand-edit it — edit plugins/oc-platform-api/agents/opencollective-analyst.md or plugins/oc-platform-api/skills/querying-opencollective-graphql/SKILL.md, then run: uv run python scripts/build_cherry_skill.py"
    ;;
esac
