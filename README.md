...
Both are **committed to the repo** (along with the corpus under `.opencrane/`) and regenerated by the [`corpus-refresh`](.github/workflows/corpus-refresh.yml) workflow with the full OpenCrane pipeline:
