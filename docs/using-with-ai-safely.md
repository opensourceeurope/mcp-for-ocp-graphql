...
The agent-facing version of this rule is in [`AGENTS.md`](../AGENTS.md) (used automatically by Claude Code) and codified for query work in the [`querying-opencollective-graphql` skill](../.claude/skills/querying-opencollective-graphql/SKILL.md).
